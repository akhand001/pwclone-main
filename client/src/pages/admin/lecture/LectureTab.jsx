...
import { SwitchDemo } from '@/components/ui/Switch1';
import { Label } from "@/components/ui/label";
import React, { useEffect, useState } from 'react'
import axios from "axios"
import { toast } from 'sonner';
import { ProgressDemo } from '@/components/ui/progress1';
    ...
    return (
        <Card>
            ...
            <CardContent>
                ...
                <div className='my-5'>
                    <Label>Video <span className='text-red-500 font-extrabold'>*</span></Label>
                    <Input
                        type="file"
                        accept="video/*"
                    ...
                    />
                    <div className='mt-5 '>
                        <SwitchDemo isFree={isFree} setIsFree={setIsFree} />
                    </div>
                    {
                        mediaProgress && (
                            <div className='my-4'>
                                <ProgressDemo value={uploadProgress} />
