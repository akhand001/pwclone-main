    ...
    try {
        ...
        if (!courseDetails) {
            return res.status(404).json({
                message: "Courses not found in Getcourse progress",
            })
        }
        ...
        console.log(error + "get course progress ");
...
export const updateLectureProgress = async (req, res) => {
    try {
        ...
        return res.status(200).json({
            messageg: "Lecture progress updated successfully",
        })
...
export const markAsInCompleted = async (req, res) => {
    try {
        ...
        if (!courseProgress) {
            return res.status(404).json({
                message: "Course1 progress not found ",
            })
        }
